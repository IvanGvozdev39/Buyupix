...
enum class CountryRepository(private val code: String, private val countryNameRes: Int, private val flagIconRes: Int, private val phoneCode: String, private val maxLengthNoCode: Int) {
    BY("BY", R.string.belarus, R.drawable.ic_flag_by, "+375", 14),
    RU("RU", R.string.russia, R.drawable.ic_flag_ru, "+7", 15),
    US("US", R.string.usa, R.drawable.ic_flag_us, "+1", 15);

    companion object {
        fun getCountryByCode(code: String): CountryRepository? {
